...
func randomize_anim():
	...
	if randomize_anim_speed : anim_speed = randf_range(0.05 * randomize_multiplier, 0.4 * randomize_multiplier)
	...
	if randomize_anim_speed2 : anim_speed2 = randf_range(0.05 * randomize_multiplier2, 0.4 * randomize_multiplier2)
