...
const l_sfx : Array = [sfx_player_jump, sfx_player_wall_jump, sfx_player_shoot, sfx_player_damage, sfx_player_heal, sfx_mechanical, sfx_mechanical3, sfx_powerUp, sfx_powerUp2, sfx_beam_enabled, sfx_combo_streak_finished, sfx_combo_tier_increased, sfx_electric_disabled2, sfx_effect_teleport, sfx_collect3, sfx_slash, sfx_break, sfx_footstep_mechanical, sfx_secret]
